    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-[#fbf9f5] via-[#e5efdf] to-[#99c9a6]">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#f0f4ea]/90 rounded-[2rem] p-8 shadow-[0_20px_60px_rgba(45,71,57,0.12)] border border-white/60 backdrop-blur-md">
          <h1 className="font-serif font-bold text-2xl text-[#1b1c1a] mb-1">Begin your journey</h1>
          <p className="text-sm text-[#56423e]/70 mb-8">Create your account to get started.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {password.length > 0 && password.length < 6 && (
                <p className="text-[0.7rem] text-[#c02a1b] mt-1.5 ml-1">At least 6 characters required</p>
              )}
            </div>
        ...
        <p className="text-center text-sm text-[#56423e]/70 mt-6">
          ...
          <Link href="/login" className="text-[#2d4739] font-bold hover:underline">
            Sign in
          </Link>
        </p>
      </div>
